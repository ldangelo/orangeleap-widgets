WidgetForm = Ext.extend(Ext.form.FormPanel, {
	...
	getParameter: function (queryString, parameterName) {
	    ...
	    if (guid == null)
			mydatastore.load({url: 'widgetform.ajax', params: {action:'create',widgettype:mydatastore.widgetForm.widgettype,customentitytype:mydatastore.widgetForm.customentitytype}});
	    else {
			mydatastore.load({url:'widgetform.ajax',params: {action:'read',widgettype:mydatastore.widgetForm.widgettype,customentitytype:mydatastore.widgetForm.customentitytype,guid:guid}});
