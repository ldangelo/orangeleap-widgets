...
<head>
	...
	Ext.onReady(function() {
		...
		params.customentitytype='online_donation';
	    ...
	    if (widgetid == null)
		mydatastore.load({url: 'widgetform.ajax', params: {action:'create',widgettype:'customentitytype',customentitytype:'online_donation'}});
	    else
		mydatastore.doRequest({url:'widgetform.ajax',params: {action:'read',widgettype:'customentitytype',customentitytype:'online_donation',widgetid:widgetid}});
	});  // Ext.onReady
</script>
    </head>
    <body>
