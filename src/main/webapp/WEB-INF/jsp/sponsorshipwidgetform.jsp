...
<head>
	...
	Ext.onReady(function() {
		...
		params.customentitytype='sponsorship';
	    ...
	    if (widgetid == null)
		mydatastore.load({url: 'widgetform.ajax', params: {action:'create',widgettype:'customentitytype',customentitytype:'sponsorship'}});
	    else
		mydatastore.doRequest({url:'widgetform.ajax',params: {action:'read',widgettype:'customentitytype',customentitytype:'sponsorship',widgetid:widgetid}});
	});  // Ext.onReady
</script>
    </head>
    <body>
