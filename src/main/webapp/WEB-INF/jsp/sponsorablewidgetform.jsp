...
<head>
	...
	Ext.onReady(function() {
		...
		params.customentitytype='sponsorable';
	    ...
	    if (widgetid == null)
		mydatastore.load({url: 'widgetform.ajax', params: {action:'create',widgettype:'customentitytype',customentitytype:'sponsorable'}});
	    else
		mydatastore.doRequest({url:'widgetform.ajax',params: {action:'read',widgettype:'customentitytype',customentitytype:'sponsorable',widgetid:widgetid}});
	});  // Ext.onReady
</script>
    </head>
    <body>
