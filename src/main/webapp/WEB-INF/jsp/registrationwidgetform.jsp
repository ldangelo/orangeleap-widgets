...
<head>
	...
	Ext.onReady(function() {
		...
		params.customentitytype='donor_profile';
	    ...
	    if (widgetid == null)
		mydatastore.load({url: 'widgetform.ajax', params: {action:'create',widgettype:'customentitytype',customentitytype:'donor_profile'}});
	    else
		mydatastore.doRequest({url:'widgetform.ajax',params: {action:'read',widgettype:'customentitytype',customentitytype:'donor_profile',widgetid:widgetid}});
	});  // Ext.onReady
</script>
    </head>
    <body>
