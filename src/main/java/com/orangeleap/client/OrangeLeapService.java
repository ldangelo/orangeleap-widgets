...
@WebServiceClient(name = "OrangeLeapService", 
                  wsdlLocation = "http://10.0.2.62:51680/orangeleap/services3.0/orangeleap.wsdl",
...
public class OrangeLeapService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.0.2.62:51680/orangeleap/services3.0/orangeleap.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://10.0.2.62:51680/orangeleap/services3.0/orangeleap.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
