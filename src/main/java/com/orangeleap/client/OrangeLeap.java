...
public interface OrangeLeap {
    ...
    @WebResult(name = "GetJobStatusResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "GetJobStatusResponse")
    @WebMethod(operationName = "GetJobStatus")
    public GetJobStatusResponse getJobStatus(
        @WebParam(partName = "GetJobStatusRequest", name = "GetJobStatusRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
    ...
    @WebResult(name = "ImportDataResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "ImportDataResponse")
    @WebMethod(operationName = "ImportData")
    public ImportDataResponse importData(
        @WebParam(partName = "ImportDataRequest", name = "ImportDataRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
    ...
    @WebResult(name = "GetJobResultResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "GetJobResultResponse")
    @WebMethod(operationName = "GetJobResult")
    public GetJobResultResponse getJobResult(
        @WebParam(partName = "GetJobResultRequest", name = "GetJobResultRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
        GetJobResultRequest getJobResultRequest
    );

    @WebResult(name = "SetEntityResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "SetEntityResponse")
    @WebMethod(operationName = "SetEntity")
    public SetEntityResponse setEntity(
        @WebParam(partName = "SetEntityRequest", name = "SetEntityRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
    ...
    @WebResult(name = "ListEntitiesResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "ListEntitiesResponse")
    @WebMethod(operationName = "ListEntities")
    public ListEntitiesResponse listEntities(
        @WebParam(partName = "ListEntitiesRequest", name = "ListEntitiesRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
    ...
    @WebResult(name = "ImportResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "ImportResponse")
    @WebMethod(operationName = "Import")
    public ImportResponse _import(
        @WebParam(partName = "ImportRequest", name = "ImportRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
    ...
    @WebResult(name = "GetEntityResponse", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/", partName = "GetEntityResponse")
    @WebMethod(operationName = "GetEntity")
    public GetEntityResponse getEntity(
        @WebParam(partName = "GetEntityRequest", name = "GetEntityRequest", targetNamespace = "http://www.orangeleap.com/orangeleap/services3.0/")
