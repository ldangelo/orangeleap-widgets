...
@WebServiceClient(name = "OrangeLeapService", 
                  wsdlLocation = "file:/var/folders/9z/9zAPZiWLE1a4+mqPUd09Y++++TI/-Tmp-/tempdir9076447852554023151.tmp/orangeleap_1.wsdl",
...
public class OrangeLeapService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/var/folders/9z/9zAPZiWLE1a4+mqPUd09Y++++TI/-Tmp-/tempdir9076447852554023151.tmp/orangeleap_1.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/var/folders/9z/9zAPZiWLE1a4+mqPUd09Y++++TI/-Tmp-/tempdir9076447852554023151.tmp/orangeleap_1.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
